...
<ul>
  <li>🌐 <strong>Клиентский веб-сайт</strong> — запись на обслуживание, услуги, отзывы</li>
  <li>🖥️ <strong>Административное приложение на Electron</strong> — управление заказами и клиентами</li>
  <li>⚙️ <strong>Единое REST API на PHP</strong> — связь компонентов (сайта и приложения) с базой данных</li>
</ul>
